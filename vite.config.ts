  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: BASE,
        icons: [
          { src: `${BASE}car-icon.png`, sizes: '180x180', type: 'image/png' },
          { src: `${BASE}car-icon.png`, sizes: '192x192', type: 'image/png', purpose: 'any maskable' },
          { src: `${BASE}car-icon.png`, sizes: '512x512', type: 'image/png', purpose: 'any maskable' },
